...
The class GTFSController organises all the tabular dataset...
"""
import glob
import pandas as pd
...
import script.GTFSGraph as gtfs_graph
...
class GTFSController:
    def __init__(self, root_dir):
        ...
        self.dfs = {}  # hold all data frames here
        self.load_txt_files()
    ...
    def display_table(self, fn):
        ...
        if fn in self.dfs.keys():
            ...
            return self.dfs[fn], grid_options
        else:
            st.write("possible file names:", self.dfs.keys())
            return None

    def display_map_tile(self):
        # the most basic map background to start with
    ...
    def display_routes_map(self, m: folium.Map, width=400, height=400):
