...
def page_0():
    st.markdown("## Welcome to GTFS2STN: Convert transit data to spatiotemporal network for accessibility analysis")
    ...
    with col1:
        components.html(html_loader("images/stops.html"), height=450)
    with col2:
        components.html(html_loader("images/tsn.html"), height=450)
    ...
    with col1:
        st.markdown("""
            ...
            """)
    with col2:
        # TODO: change this with another type of description...
