...
def page_1():
    ...
    with col2:
        # Option 2. Upload your zipped file for analysis
        ...
        if st.button(
            ...
            with st.spinner('Processing GTFS documents...'):
                try:
                    ...
                    st.warning("Cannot process uploaded file, please check if data formats & file names are correct")
    return gtfs_obj
