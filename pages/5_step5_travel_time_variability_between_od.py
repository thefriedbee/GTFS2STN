    ...
    if (
        ...
        for depart_min in np.arange(min_start, min_end, step=10):  # step is every 10 minutes
            ...
            for pth in all_paths:
                travel_t, wait_t, walk_t = GRAPH_OBJ.get_travel_time_info_from_pth(
                    GRAPH_OBJ.G,
                    pth,
                )
                tt = travel_t + wait_t + walk_t
                travel_ts.append(travel_t)
